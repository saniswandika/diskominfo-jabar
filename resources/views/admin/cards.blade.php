...
@section('content')
        ...
        <li class="nav-item flex-auto text-center" role="presentation">
            ...
            aria-controls="tabs-homeFill" aria-selected="true">Program</a>
        </li>
        <li class="nav-item flex-auto text-center" role="presentation">
            ...
            aria-controls="tabs-profileFill" aria-selected="false">Tambah program</a>
        </li>
        <li class="nav-item flex-auto text-center" role="presentation">
            ...
            aria-controls="tabs-messagesFill" aria-selected="false">List Seluruh program</a>
        </li>
        </ul>
