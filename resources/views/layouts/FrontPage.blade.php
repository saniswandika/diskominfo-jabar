        ...
        <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
          <div class="dropdown">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                <a href="#">Command Center Jabar</a>
                <a href="#">Ekosistem Data Jabar</a>
                <a href="#">Desa Digital</a>
                <a href="#">Citarum Harum</a>
                <a href="#">Sapa Warga</a>
                <a href="#">JabarProv.go.id</a>
                <a href="#">Humas Jabar</a>
                <a href="#">Jabar Saber Hoaks</a>
                <a href="#">JabarProv.go.id</a>
              </div>
            </div> 
          <div class="dropdown">
